export default function TermsOfService() {
  return (
    <div className="max-w-4xl mx-auto px-6 py-12">
      ...
      <p className="mb-4">
        By using Forward Collective's website, you agree to these Terms of Service.
      </p>
      ...
      <p className="mb-4">
        All website content, branding, images, and designs remain the property of Forward Collective.
      </p>

      <h2 className="text-2xl font-semibold mt-8 mb-4">Contact</h2>
      <p>
        Questions may be directed to forwardap55@gmail.com.
      </p>
    </div>
  );
}
